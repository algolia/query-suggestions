...
major_tag=`echo "$ALGOLIASEARCH_POPULAR_VERSION" | sed -r "s/${version_regex}/\1/g"`
minor_tag=`echo "$ALGOLIASEARCH_POPULAR_VERSION" | sed -r "s/${version_regex}/\1.\2/g"`
patch_tag=`echo "$ALGOLIASEARCH_POPULAR_VERSION" | sed -r "s/${version_regex}/\1.\2.\3/g"`
